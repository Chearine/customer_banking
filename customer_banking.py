...
def main():
    ...
    print(f"The given months are {savings_maturity}")
    ...
    print(f"Your updated savings account balance is $ {updated_cd_balance:.2f}")
    print("Your interest earned is $", format(interest_earned,',.2f') )
    print(f"The given months are {cd_maturity}")
